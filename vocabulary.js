...
const vocabulary5 = [
    { category: "nouns", kana: "うみ", kanji: "海", english: "sea" },
    { category: "nouns", kana: "きって", kanji: "切手", english: "postal stamps" },
    { category: "nouns", kana: "きっぷ", kanji: "切符", english: "ticket" },
    { category: "nouns", kana: "サーフィン", english: "surfing" },
    { category: "nouns", kana: "しゅくだい", kanji: "宿題", english: "homework" },
    { category: "nouns", kana: "たべもの", kanji: "食べ物", english: "food" },
    { category: "nouns", kana: "たんじょうび", kanji: "誕生日", english: "birthday" },
    { category: "nouns", kana: "テスト", english: "test" },
    { category: "nouns", kana: "てんき", kanji: "天気", english: "weather" },
    { category: "nouns", kana: "のみもの", kanji: "飲み物", english: "drink" },
    { category: "nouns", kana: "はがき", kanji: "葉書", english: "postcard" },
    { category: "nouns", kana: "バス", english: "bus" },
    { category: "nouns", kana: "ひこうき", kanji: "飛行機", english: "airplane" },
    { category: "nouns", kana: "へや", kanji: "部屋", english: "room" },
    { category: "nouns", kana: "ぼく", kanji: "僕", english: "I (used by men)" },
    { category: "nouns", kana: "やすみ", kanji: "休み", english: "holiday; day off; absence" },
    { category: "nouns", kana: "りょこう", kanji: "旅行", english: "travel" },
    { category: "i-adjectives", kana: "あたらしい", kanji: "新しい", english: "new" },
    { category: "i-adjectives", kana: "あつい", kanji: "暑い", english: "hot (weather)" },
    { category: "i-adjectives", kana: "あつい", kanji: "熱い", english: "hot (objects)" },
    { category: "i-adjectives", kana: "いそがしい", kanji: "忙しい", english: "busy (people/days)" },
    { category: "i-adjectives", kana: "おおきい", kanji: "大きい", english: "large" },
    { category: "i-adjectives", kana: "おもしろい", kanji: "面白い", english: "interesting" },
    { category: "i-adjectives", kana: "こわい", kanji: "怖い", english: "frightening" },
    { category: "i-adjectives", kana: "さむい", kanji: "寒い", english: "cold (weather-not used for objects)" },
    { category: "i-adjectives", kana: "たのしい", kanji: "楽しい", english: "fun" },
    { category: "i-adjectives", kana: "ちいさい", kanji: "小さい", english: "small" },
    { category: "i-adjectives", kana: "つまらない", english: "boring" },
    { category: "i-adjectives", kana: "ふるい", kanji: "古い", english: "old (thing - not used for people)" },
    { category: "i-adjectives", kana: "むずかしい", kanji: "難しい", english: "difficult" },
    { category: "i-adjectives", kana: "やさしい", english: "easy (problem); kind (person)" },
    { category: "i-adjectives", kana: "やすい", kanji: "安い", english: "inexpensive; cheap (thing)" },
    { category: "na-adjectives", kana: "きらいな", kanji: "嫌い", english: "disgusted with; to dislike" },
    { category: "na-adjectives", kana: "きれいな", english: "beautiful; clean" },
    { category: "na-adjectives", kana: "げんきな", kanji: "元気", english: "healthy; energetic" },
    { category: "na-adjectives", kana: "しずかな", kanji: "静か", english: "quiet" },
    { category: "na-adjectives", kana: "すきな", kanji: "好き", english: "fond of; to like" },
    { category: "na-adjectives", kana: "だいきらいな", kanji: "大嫌い", english: "to hate" },
    { category: "na-adjectives", kana: "だいすきな", kanji: "大好き", english: "very fond of; to love" },
    { category: "na-adjectives", kana: "にぎやかな", english: "lively" },
    { category: "na-adjectives", kana: "ハンサムな", english: "handsome" },
    { category: "na-adjectives", kana: "ひまな", kanji: "暇", english: "not busy; to have a lot of free time" },
    { category: "u-verbs", kana: "およぐ", kanji: "泳ぐ", english: "to swim" },
    { category: "u-verbs", kana: "きく", kanji: "聞く", english: "to ask" },
    { category: "u-verbs", kana: "のる", kanji: "乗る", english: "to ride; to board" },
    { category: "u-verbs", kana: "やる", english: "to do; to perform" },
    { category: "ru-verbs", kana: "でかける", kanji: "出かける", english: "to go out" },
    { category: "others", kana: "いっしょに", kanji: "一緒に", english: "together" },
    { category: "others", kana: "それから", english: "and then" },
    { category: "others", kana: "だいじょうぶ", kanji: "大丈夫", english: "It's okay.; Not to worry.; Everything is under control." },
    { category: "others", kana: "とても", english: "very" },
    { category: "others", kana: "どんな", english: "what kind of..." },
    { category: "others", kana: "〜まい", kanji: "〜枚", english: "[counter for flat objects]" },
    { category: "others", kana: "〜まで", english: "to (a place); as far as (a place); till (a time)" }
]


export { vocabulary, vocabulary5 };
